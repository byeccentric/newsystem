...
class Ftps extends Page {
  constructor() {
    ...
    this.links = {
      table: [
        {
          name: 'Добавить',
          onClick: e => this.changeCommand(e, 'add', 'Добавить доступ FTP'),
        },
      ],
      edit: [
        {
          name: 'К списку',
          onClick: e => this.changeCommand(e, 'table', 'Список доступов FTP'),
        },
      ],
      add: [
        {
      ...
      return (
        <React.Fragment>
          <Table
            ...
            onEdit={(e, id) =>
              this.changeCommand(e, 'edit', 'Редактировать доступ FTP', id)
            }
          />
        </React.Fragment>
      )
  ...
  edit() {
    ...
    return <EditComponent {...item} onSubmit={this.editFtpItem.bind(this)} />
  }
}
